...
**Пришлось откатить на gulp 4, так как падал optimizeRaster, а именно sharp @thws**
...
<!-- ! Манифест фавиконок не был виден при дев сборке. Добавлена дополнительная задача copyDevStatic в gulpfile.js @thws  -->
